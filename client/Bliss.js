...
function displayResults(results) {
    ...
    results.forEach(car => {
        ...
        const makeText = car.make ? car.make : '';
        const modelText = car.model ? car.model : '';
        const displayName = `${makeText} ${modelText}`.trim();
        const imagePath = car.image && !car.image.startsWith('images/') ? `images/${car.image}` : (car.image || '');
